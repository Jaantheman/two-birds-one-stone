...
def main():
    ...
    while splashScreenTimer < 2:
        ...
        startMessage = font_32.render("CREATED BY POLYMARS", True, (48, 93, 120))
    ...
    while running:
        ...
        for projectile in projectiles:
            ...
            if projectile.direction ==-1 and checkCollisions(shooter.position.x, shooter.position.y, shooter.width, shooter.height, projectile.position.x, projectile.position.y, projectile.width, projectile.height):
                projectiles.remove(projectile)
        ...
        if (currentLevel ==7) and len(birds) ==0:
            pygame.mixer.Sound.play(winfx)
            currentLevel += 1
            reset(currentLevel)
